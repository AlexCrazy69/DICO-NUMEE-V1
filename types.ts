...
export type View = 'home' | 'dictionary' | 'quiz' | 'games' | 'memory-game' | 'fill-in-the-blank' | 'certification' | 'login' | 'admin' | 'contact' | 'scrabble-game' | 'user-dashboard' | 'guide-touristique';
