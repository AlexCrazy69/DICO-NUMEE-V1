...
const Certification: React.FC<CertificationProps> = ({ setView }) => {
      ...
      return (
        <div className="space-y-12">
          <div className="text-center">
            <h2 className="text-4xl font-bold text-slate-800 dark:text-white flex items-center justify-center gap-3"><Award className="w-10 h-10 text-yellow-500" />Centre de Certification</h2>
